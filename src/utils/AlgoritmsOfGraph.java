...
public class AlgoritmsOfGraph {
    ...
    private static void dfs_visit(Node[] G, int s, Color[] cor,Integer [] tempoInicio, Integer [] tempoFim, Integer [] pai){
        ...
        tempo++;
        tempoInicio[s] =  AlgoritmsOfGraph.tempo;
        cor[s] = Color.CINZA;
        ...
        AlgoritmsOfGraph.tempo += 1;
        tempoFim[s] =  AlgoritmsOfGraph.tempo;
    }

    public static Queue TopologicalSort(Grafo Graph, boolean resume){
        Node [] G = Graph.listaGrafo;
        Color cor[] = new Color[G.length];
        Integer tempoInicio[] = new Integer[G.length];
        Integer tempoFim[] = new Integer[G.length];
        Integer pai[] = new Integer[G.length];
    ...
    public static Queue TopologicalSort(Graph Graph, boolean resume){
        Node [] G = Graph.GraphList;
        Color cor[] = new Color[G.length];
        Integer tempoInicio[] = new Integer[G.length];
        Integer tempoFim[] = new Integer[G.length];
        Integer pai[] = new Integer[G.length];
    ...
    private static void componentes_fortemente_conexas(Grafo G){
        ...
        Queue finalizacoes = AlgoritmsOfGraph.TopologicalSort(G,false);
